...
function updateComment(model) {
    ...
    $("#btnUpdate").empty();
    $("#btnUpdate").append(
        `<button class="btn btn-primary" onclick="update()"  type="button">Comment</button>
 ...
 function refesh() {
    ...
    $("#btnUpdate").empty();
    $("#btnUpdate").append(
        `<button class="btn btn-primary" onclick="AddComment()" id="btnComment" type="button">Comment</button>
        `
    )
 }
